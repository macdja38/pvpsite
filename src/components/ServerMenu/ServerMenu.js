    ...
    return (
      <div className={cx(s.root, className)} role="navigation">
        <div className={s.menu}>
          <Link className={s.link} to={`/user/${user.id}/server/${serverId}/music`}>Music</Link>
          <Link className={s.link} to={`/user/${user.id}/server/${serverId}/permissions`}>Permissions</Link>
